...
#import "XHVColorPath.h"
#import "XHVLineView.h"

@interface XHVToolView ()<ColorViewDelegate>
// 上一次选中的按钮
@property (weak, nonatomic) UIButton *selectedButton;
// 按钮选中的红线
@property (weak, nonatomic) XHVLineView *lineView;

// 选择颜色视图
@property (weak, nonatomic) XHVColorPath *colorView;
@end

@implementation XHVToolView
...
- (void)drawLineWithButton:(UIButton *)button
{
    ...
    if (self.lineView == nil) {
        XHVLineView *lineView = [[XHVLineView alloc] initWithFrame:CGRectMake(x, y, w, 2.0)];
...
- (void)showHideColorView
{
    ...
    if (self.colorView == nil) {
        XHVColorPath *view = [[XHVColorPath alloc] initWithFrame:CGRectMake(0, -self.bounds.size.height, self.bounds.size.width, kSubViewHeight)];
